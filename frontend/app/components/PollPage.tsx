          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-4">
              <motion.div
                ...
                className="w-12 h-12 bg-gradient-to-r from-purple-400 to-pink-400 rounded-lg flex items-center justify-center"
              >
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white">QuickPolls</h1>
                <p className="text-purple-200 text-sm">Real-time opinion polling</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white font-medium">{liveUsers} users online</span>
              </div>
              ...
              <motion.button
                ...
                className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2"
              >
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 pb-12">
        {loading ? (
          ...
          >
            ...
            <p className="text-purple-200 mb-6">Be the first to create a poll!</p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => setShowCreateModal(true)}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <AnimatePresence>
              {sortedPolls.map((poll, index) => (
                ...
                >
                  <PollCard poll={poll} onUpdate={handleUpdate} onDelete={handleDelete} />
                </motion.div>
              ))}
            </AnimatePresence>
          </div>
