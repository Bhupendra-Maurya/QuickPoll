        ...
        {poll.options.map((option, index) => {
          ...
          return (
            ...
            >
              ...
              <motion.div
                className={`absolute inset-0 bg-linear-to-r ${getGradientColor(
                  index
                ...
                <div className="flex items-center gap-3">
                  ...
                  {isWinning && totalVotes > 0 && (
                    <motion.span
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className="px-2 py-1 bg-linear-to-r from-yellow-400 to-orange-400 text-white text-xs rounded-full font-bold"
                    >
                      Leading
                    </motion.span>
                  )}
        ...
        <div className="relative">
          ...
          <AnimatePresence>
            {showDeleteConfirm && (
              ...
              >
                <p className="text-white text-sm mb-2 whitespace-nowrap">
                  Delete this poll?
                </p>
                <div className="flex gap-2">
                  <button
