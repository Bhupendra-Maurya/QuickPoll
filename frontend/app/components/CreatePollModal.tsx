  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ scale: 1, y: 0 }}
        exit={{ scale: 0.9, y: 20 }}
        className="bg-gradient-to-br from-purple-900 to-indigo-900 rounded-2xl p-8 max-w-lg w-full border border-white/20 shadow-2xl"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-purple-200 mb-2 font-medium">Question</label>
            <input
              type="text"
              value={question}
          ...
          <div>
            <label className="block text-purple-200 mb-2 font-medium">Options</label>
          ...
          <div className="flex gap-3 pt-4">
            <motion.button
              ...
              type="submit"
              disabled={creating}
              className="flex-1 py-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold shadow-lg disabled:opacity-50"
            >
